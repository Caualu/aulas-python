...
for distanciaporatleta2 in lista_atletas2:
...
opcao = int(input(f"para ver os resultados das distaciaparatletas\n digite 1 - para ver o resultados distaciaparatletas1\n digite 2 - para ver o resultado do distanciaporatleta2\n digite 3 -"))

if opcao == 1:
    print(f" para distanciaporatleta\n - distanciaporatleta1\n - distanciaporatleta2\n .")
